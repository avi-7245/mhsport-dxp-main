...
@Component(
		property = {
			...
			"javax.portlet.display-name=MhdsysAthleteInjuryDetailsWeb",
			"javax.portlet.init-param.template-path=/",
			"javax.portlet.init-param.view-template=/jsps/injury-details.jsp",
...
public class InjuryDetailsWebPortlet extends MVCPortlet{
